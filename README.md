...
*(Add your block diagram image here: `![Block Diagram](path/to/image.png)`)*
...
*(Add your Sleep Modes table image here if desired)*
...
* `Projects/NUCLEO-L432KC/Templates/`: Contains the active project files.
  ...
  * `ssd1306/`: An open-source SSD1306 OLED library utilized for the graphical interface (licenses retained within). 
